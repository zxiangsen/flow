(function() {
    ...
    function(e) {
        ...
        "");
        if ("undefined" == typeof o && (o = ""), e.format && "password" === e.format && (n = "password"), e.valueId && (r = " id='" + e.valueId + "'"), ("string" == typeof o || o instanceof String) && (o = o.replace(/'/g, "&apos;")), a) t = "<textarea class='body-textarea" + (e.required ? " required": "") + "' name='" + e.name + "'" + r + s,
    ...
    this.Handlebars.templates.operation = Handlebars.template({
        ...
        16 : function(e, t, n, r) {
            ...
            var i, a, o = "function",
                s = t.helperMissing,
                u = this.escapeExpression,
                l = "          <h4><span data-sw-translate>Authorizations</span></h4>\n            ";
            return i = t["if"].call(e, null != e ? e.successDescription: e, {
                name: "if",
                hash: {},
                fn: this.program(17, r),
        ...
        17 : function(e, t, n, r) {
             ...
             */
            if(e.authorizations){
                var auth = '<div class="markdown">';
                for(var i=0;i<e.authorizations.length;i++){
                    for(var key in e.authorizations[i]){
                        auth = auth + "; " + key;
                    }
                }
                auth = auth.replace('>; ', '>');
                ...
                return '<div class="markdown">NONE</div>';
            }
        },
        19 : function(e, t, n, r) {
        ...
        return function t(e, n, r) {
            ...
            3 : [function(e, t, n) {
                ...
                y.prototype.build = function(e) {
                    ...
                    var n = {
                        ...
                        on: {
                            ...
                            response: function(e) {
                                ...
                                (new l).resolve(n, t.url, t.buildFromSpec, t),
                                t.isValid = !0;
                                else {
                                    var r = new p;
                                    t.oldSwaggerObject = t.swaggerObject,
                                    r.setDocumentationLocation(t.url),
                                    r.convert(n, t.clientAuthorizations, t.options,
                                    function(e) {
                                        t.swaggerObject = e,
                    ...
                    setTimeout(function() { (new l).resolve(t.spec, t.buildFromSpec, t)
                    },
                    10);
                    else {
                        if (this.clientAuthorizations.apply(n), e) return n; (new c).execute(n, this.options)
                    }
                ...
                y.prototype.buildFromSpec = function(e) {
                    ...
                    r.forEach(e.paths,
                    function(e, t) {
                        r.isPlainObject(e) && r.forEach(m,
                        function(i) {
                            var o = e[i];
                            if (!r.isUndefined(o)) {
                                if (!r.isPlainObject(o)) return void a.log("The '" + i + "' operation for '" + t + "' path is not an Operation Object");
                                var l = o.tags; (r.isUndefined(l) || !r.isArray(l) || 0 === l.length) && (l = o.tags = ["default"]);
                ...
                y.prototype.help = function(e) {
                    var t = "";
                    return this instanceof y ? r.forEach(this.apis,
                    function(e, n) {
            ...
            5 : [function(e, t, n) {
                ...
                l.prototype.execute = function(e, t) {
                    ...
                    n.opts = t || {};
                    var r = !1;
                    if ("undefined" != typeof window && "undefined" != typeof window.jQuery && (r = !0), this.isInternetExplorer() && (e.useJQuery === !1 || !r)) throw new Error("Unsupported configuration! JQuery is required but not available"); (e && e.useJQuery === !0 || this.isInternetExplorer() && r) && (n = new s(t));
                    var i = e.on.response,
                    a = function(e) {
            ...
            6 : [function(e, t, n) {
                ...
                a.prototype.processAllOf = function(e, t, n, r, i, a) {
                    ...
                    }), o = 0; o < l.length; o++) u = l[o],
                    s = "/definitions/" + t + "/allOf",
                    this.resolveInline(e, a, u, r, i, s)
                },
                a.prototype.resolve = function(e, t, n, a) {
                    ...
                    for (f in e.definitions) {
                        ...
                        for (y in w.properties) m = w.properties[y],
                        i.isArray(m.allOf) ? this.processAllOf(u, f, m, b, D, e) : this.resolveTo(u, m, b, "/definitions");
                        w.allOf && this.processAllOf(u, f, w, b, D, e)
                    }
                    for (f in e.paths) {
                        var A, C, x;
                        d = e.paths[f];
                        for (A in d) if ("$ref" === A) o = "/paths" + f,
                        this.resolveInline(u, e, d, b, D, o);
                        else {
                            C = d[A];
                            var E = d.parameters || [],
                            F = C.parameters || [];
                        ...
                        if (u === L.root) {
                            if ("ref" === L.resolveAs) {
                                ...
                                if (L.key.indexOf("../") >= 0) {
                                    ...
                                    for (R = 0; R < U.length; R++) R > 0 && (M += "/"),
                                    M += U[R];
                                    L.root = M,
                                    T.push(L)
                                } else if (I = L.key.split("#"), 2 === I.length) { (0 === I[0].indexOf("http://") || 0 === I[0].indexOf("https://")) && (L.root = I[0]),
                                    o = I[1].split("/");
                                    var q, H = e;
                    ...
                    function(e, t, n) {
                        if (null === e.root || e.root === u) n.resolveItem(t, h, b, v, D, e),
                        g += 1,
                        g === _ && n.finish(t, u, b, v, D, l, !0);
                        else {
                            var i = {
                                useJQuery: !1,
                                url: e.root,
                ...
                a.prototype.finish = function(e, t, n, r, i, a, o) {
                    ...
                    for (s in n) {
                        ...
                        l = u.key,
                        c = r[l];
                        if (c) if (e.definitions = e.definitions || {},
                        "ref" === u.resolveAs) {
                ...
                a.prototype.resolveInline = function(e, t, n, r, i, a) {
                    ...
                    if (p) {
                        if (0 === p.indexOf("../")) {
                            ...
                            for (e = "", o = 0; o < u.length - 1; o++) o > 0 && (e += "/"),
                            e += u[o];
                            h = !0
                        }
                        if (p.indexOf("#") >= 0) if (0 === p.indexOf("/")) l = p.split("#"),
                        s = e.split("//"),
                        u = s[1].split("/"),
                        e = s[0] + "//" + u[0] + l[0],
                        a = l[1];
                            ...
                            if (l = p.split("#"), "" !== l[0]) {
                                if (u = e.split("/"), u = u.slice(0, u.length - 1), !h) {
                                    e = "";
                                    for (var f = 0; f < u.length; f++) f > 0 && (e += "/"),
                                    e += u[f]
                                }
                                e += "/" + p.split("#")[0]
                            }
                ...
                a.prototype.resolveTo = function(e, t, n, r) {
                    ...
                    if ("undefined" != typeof s) {
                        if (s.indexOf("#") >= 0) {
                            var l = s.split("#");
                            if (l[0] && 0 === s.indexOf("/"));
                            else if (l[0] && 0 === l[0].indexOf("http")) u = l[0],
                            s = l[1];
                            ...
                            r = l[1]
                        } else if (0 === s.indexOf("http://") || 0 === s.indexOf("https://")) u = s,
                        r = "";
                        else {
                            for (a = e.split("/"), u = "", o = 0; o < a.length - 1; o++) u += a[o] + "/";
                            u += s,
                                ...
                                for (var l = 0; l < s.length; l++) {
                                    ...
                                    for (var h in c) if (u.hasOwnProperty(h)) if ("properties" === h) {
                                        ...
                                        for (r in f) {
                                            ...
                                            var d = f[r]["x-resolved-from"]; ("undefined" == typeof d || "self" === d) && (d = p),
                                    ...
                                    else if (u[h] = i.cloneDeep(c[h]), "properties" === h) for (r in u[h]) u[h][r]["x-resolved-from"] = p
                                }
                                t[a] = u
                            }
                        }
            ...
            7 : [function(e, t, n) {
                ...
                function o(e, t, n, r) {
                    ...
                    l.forEach(e.properties,
                    function(e, i) {
                        var s = l.cloneDeep(e);
                        s["default"] = r(e),
                        a[i] = o(s, t, n, r)
                    })) : "array" === s && (a = [], l.isArray(e.items) ? l.forEach(e.items,
                    function(e) {
                        a.push(o(e, t, n, r))
                ...
                function s(e, t, n, i) {
                    function a(e, t, r) {
                        ...
                        r !== !0 && (f[a] = l.isUndefined(i) ? {}: i.definition),
                        a
                    }
                    function o(e) {
                    ...
                    function c(e, t) {
                        ...
                        c = "array" === e.type,
                        f = p + t + " " + (c ? "[": "{") + h;
                        if (t && d.push(t), c) l.isArray(e.items) ? f += "<div>" + l.map(e.items,
                        function(e) {
                            var t = e.type || "object";
                            ...
                            if (l.isPlainObject(e.properties)) var m = l.map(e.properties,
                            function(t, r) {
                    ...
                    h = "</span>";
                    if (l.isObject(arguments[0]) && (e = void 0, t = arguments[0], n = arguments[1], i = arguments[2]), n = n || {},
                    t = u.resolveSchema(t), l.isEmpty(t)) return p + "Empty" + h;
                    ...
                    for (var f = {},
                    d = [], m = 0, y = c(t, e); l.keys(f).length > 0;) l.forEach(f,
                    function(e, t) {
            ...
            8 : [function(e, t, n) {
                ...
                a.prototype.authorizations = function(e) { ! i.isObject(e)
                },
            ...
            10 : [function(e, t, n) {
                ...
                l = t.exports = function(e, t, n, r, i, a, s, u, l) {
                    ...
                    if (e = e || {},
                    a = a || {},
                    e && e.options && (this.client = e.options.client || null, this.requestInterceptor = e.options.requestInterceptor || null, this.responseInterceptor = e.options.responseInterceptor || null), this.authorizations = a.security, this.basePath = e.basePath || "/", this.clientAuthorizations = l, this.consumes = a.consumes || e.consumes || ["application/json"], this.produces = a.produces || e.produces || ["application/json"], this.deprecated = a.deprecated, this.description = a.description, this.host = e.host || "localhost", this.method = r || c.push("Operation " + n + " is missing method."), this.models = u || {},
                    ...
                    this.scheme = t || e.scheme || "http", this.schemes = a.schemes || e.schemes, this.security = a.security, this.summary = a.summary || "", this.type = null, this.useJQuery = e.useJQuery, this.enableCookies = e.enableCookies, this.parameterMacro = e.parameterMacro ||
                    function(e, t) {
                        return t["default"]
                    },
                    ...
                    for (p = 0; p < this.parameters.length; p++) {
                        ...
                        d.isList = !0, d["enum"] = [!0, !1]), "undefined" != typeof d["x-example"]) {
                            var y = d["x-example"];
                            d["default"] = y
                        }
                        if (d["x-examples"]) {
                    ...
                    if (A[200] ? (w = A[200], b = "200") : A[201] ? (w = A[201], b = "201") : A[202] ? (w = A[202], b = "202") : A[203] ? (w = A[203], b = "203") : A[204] ? (w = A[204], b = "204") : A[205] ? (w = A[205], b = "205") : A[206] ? (w = A[206], b = "206") : A["default"] && (w = A["default"], b = "default"), w && w.schema) {
                        ...
                        delete A[b],
                        x ? (this.successResponse = {},
                        C = this.successResponse[b] = x) : w.schema.type && "object" !== w.schema.type && "array" !== w.schema.type ? (this.successResponse = {},
                        C = this.successResponse[b] = w.schema) : (this.successResponse = {},
                        C = this.successResponse[b] = new o(void 0, w.schema || {},
                ...
                l.prototype.getBody = function(e, t, n) {
                    ...
                    if (e["Content-Type"] && e["Content-Type"].indexOf("multipart/form-data") >= 0 && (h = !0), r && !h) {
                        var f = "";
                        for (a in s) o = s[a],
                        "undefined" != typeof o && ("" !== f && (f += "&"), f += encodeURIComponent(a) + "=" + encodeURIComponent(o));
                        i = f
                    } else if (h && n.useJQuery) {
                        var d = new FormData;
                        d.type = "formData";
                        for (a in s) o = t[a],
                        "undefined" != typeof o && ("file" === o.type && o.value ? (delete e["Content-Type"], d.append(a, o.value)) : d.append(a, o));
                        i = d
                    }
                    return i
                },
            ...
            15 : [function(e, t, n) {
                ...
                function S(e) {
                    ...
                    for (var n = "",
                    r = 0; t > r;) n += String.fromCharCode.apply(String, e.slice(r, r += X));
                    return n
                }
                function k(e, t, n) {
                    var r = "";
                ...
                function q(e, t) {
                    ...
                    a = [], o = 0; r > o; o++) {
                        if (n = e.charCodeAt(o), n > 55295 && 57344 > n) {
                            if (!i) {
                                if (n > 56319) { (t -= 3) > -1 && a.push(239, 191, 189);
                                    continue
                                }
                                if (o + 1 === r) { (t -= 3) > -1 && a.push(239, 191, 189);
                                    continue
                                }
                                i = n;
                                continue
                            }
                            if (56320 > n) { (t -= 3) > -1 && a.push(239, 191, 189),
                                i = n;
                                continue
                            }
                ...
                i.prototype.copy = function(e, t, n, r) {
                    ...
                    var a, o = r - n;
                    if (this === e && t > n && r > t) for (a = o - 1; a >= 0; a--) e[a + t] = this[a + n];
                    else if (1e3 > o || !i.TYPED_ARRAY_SUPPORT) for (a = 0; o > a; a++) e[a + t] = this[a + n];
            ...
            23 : [function(e, t, n) {
                ...
                function r(e, t) {
                    ...
                    u = e.compiledTypeMap[o],
                    u && j.call(u.styleAliases, s) && (s = u.styleAliases[s]),
                    n[o] = s;
                    return n
                }
                function i(e) {
                ...
                function h(e, t) {
                    ...
                    s = 0,
                    u = 0,
                    l = a.exec(e); l;) n = l.index,
                    n - u > t && (r = s !== u ? s: n, o && (o += "\n"), i = e.slice(u, r), o += i, u = r + 1),
                    s = n + 1,
                    l = a.exec(e);
                    return o && (o += "\n"),
                ...
                function g(e, t, n) {
                    ...
                    a = c[r],
                    o = n[a],
                    b(e, t, a, !1, !1) && (e.dump.length > 1024 && (s += "? "), s += e.dump + ": ", b(e, t, o, !1, !1) && (s += e.dump, u += s));
                    e.tag = l,
                    e.dump = "{" + u + "}"
                }
                function v(e, t, n, r) {
                    ...
                    for (i = 0, a = f.length; a > i; i += 1) c = "",
                    r && 0 === i || (c += s(e, t)),
                    o = f[i],
                    u = n[o],
                    b(e, t + 1, o, !0, !0, !0) && (l = null !== e.tag && "?" !== e.tag || e.dump && e.dump.length > 1024, l && (c += e.dump && I === e.dump.charCodeAt(0) ? "?": "? "), c += e.dump, l && (c += s(e, t)), b(e, t + 1, u, !0, l) && (c += e.dump && I === e.dump.charCodeAt(0) ? ":": ": ", c += e.dump, p += c));
                    e.tag = h,
                    e.dump = p || "{}"
                }
                function D(e, t, n) {
                ...
                function A(e, t, n) {
                    ...
                    else if (t.push(e), Array.isArray(e)) for (i = 0, a = e.length; a > i; i += 1) A(e[i], t, n);
                    else for (r = Object.keys(e), i = 0, a = r.length; a > i; i += 1) A(e[r[i]], t, n)
                }
                function C(e, t) {
                    t = t || {};
                    var n = new a(t);
            ...
            25 : [function(e, t, n) {
                ...
                function g(e, t, n) {
                    var r, i, a, o;
                    for (M.isObject(n) || d(e, "cannot merge mappings; the provided source object is unacceptable"), r = Object.keys(n), a = 0, o = r.length; o > a; a += 1) i = r[a],
                    z.call(t, i) || (t[i] = n[i])
                }
                function v(e, t, n, r, i) {
                    var a, o;
                    if (r = String(r), null === t && (t = {}), "tag:yaml.org,2002:merge" === n) if (Array.isArray(i)) for (a = 0, o = i.length; o > a; a += 1) g(e, t, i[a]);
                    else g(e, t, i);
                    else t[r] = i;
                    return t
                }
                ...
                function b(e, t, n) {
                    ...
                    o = e.input.charCodeAt(e.position); 0 !== o;) {
                        ...
                        while (10 !== o && 13 !== o && 0 !== o);
                        if (!r(o)) break;
                        for (D(e), o = e.input.charCodeAt(e.position), a++, e.lineIndent = 0; 32 === o;) e.lineIndent++,
                ...
                function E(e, t) {
                    ...
                    for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; 0 !== (c = e.input.charCodeAt(e.position));) {
                        if (34 === c) return y(e, n, e.position, !0),
                        e.position++,
                        !0;
                        if (92 === c) {
                            ...
                            e.position++;
                                ...
                                for (a = l, o = 0; a > 0; a--) c = e.input.charCodeAt(++e.position),
                                (l = s(c)) >= 0 ? o = (o << 4) + l: d(e, "expected hexadecimal character");
                                e.result += p(o),
                                e.position++
                ...
                function F(e, t) {
                    ...
                    for (null !== e.anchor && (e.anchorMap[e.anchor] = r), f = e.input.charCodeAt(++e.position); 0 !== f;) {
                        if (b(e, !0, t), f = e.input.charCodeAt(e.position), f === o) return e.position++,
                        e.tag = y,
                        e.anchor = g,
                ...
                function S(e, t) {
                    ...
                    for (e.kind = "scalar", e.result = ""; 0 !== s;) if (s = e.input.charCodeAt(++e.position), 43 === s || 45 === s) Q === u ? u = 43 === s ? G: X: d(e, "repeat of a chomping mode identifier");
                    else {
                        if (! ((o = l(s)) >= 0)) break;
                    ...
                    for (; 0 !== s;) {
                        for (D(e), e.lineIndent = 0, s = e.input.charCodeAt(e.position); (!c || e.lineIndent < p) && 32 === s;) e.lineIndent++,
                ...
                function k(e, t) {
                    ...
                    u = [],
                    l = !1;
                    for (null !== e.anchor && (e.anchorMap[e.anchor] = u), i = e.input.charCodeAt(e.position); 0 !== i && 45 === i && (r = e.input.charCodeAt(e.position + 1), a(r));) if (l = !0, e.position++, b(e, !0, -1) && e.lineIndent <= t) u.push(null),
                    ...
                    for (null !== e.anchor && (e.anchorMap[e.anchor] = p), u = e.input.charCodeAt(e.position); 0 !== u;) {
                        if (r = e.input.charCodeAt(e.position + 1), s = e.line, 63 !== u && 58 !== u || !a(r)) {
                            ...
                            if (e.line === s) {
                                ...
                                a(u) || d(e, "a whitespace character is expected after the key-value separator within a block mapping"),
                                y && (v(e, p, h, f, null), h = f = m = null),
                                g = !0,
                                y = !1,
                                o = !1,
                                h = e.tag,
                        ...
                        } else 63 === u ? (y && (v(e, p, h, f, null), h = f = m = null), g = !0, y = !0, o = !0) : y ? (y = !1, o = !0) : d(e, "incomplete explicit mapping pair; a key node is missed"),
                        e.position += 1,
                        u = r;
                ...
                function T(e) {
                    ...
                    e.anchorMap = {}; 0 !== (s = e.input.charCodeAt(e.position)) && (b(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || 37 !== s));) {
                ...
                for (var M = e("./common"), N = e("./exception"), q = e("./mark"), H = e("./schema/default_safe"), V = e("./schema/default_full"), z = Object.prototype.hasOwnProperty, Y = 1, J = 2, W = 3, K = 4, Q = 1, X = 2, G = 3, Z = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, ee = /[\x85\u2028\u2029]/, te = /[,\[\]\{\}]/, ne = /^(?:!|!!|![a-z\-]+!)$/i, re = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i, ie = new Array(256), ae = new Array(256), oe = 0; 256 > oe; oe++) ie[oe] = c(oe) ? 1 : 0,
                ae[oe] = c(oe);
                var se = {
                    YAML: function(e, t, n) {
                        var r, i, a;
            ...
            34 : [function(e, t, n) {
                ...
                function i(e) {
                    ...
                    o = 0,
                    u = [];
                    for (t = 0; i > t; t++) t % 4 === 0 && t && (u.push(o >> 16 & 255), u.push(o >> 8 & 255), u.push(255 & o)),
            ...
            50 : [function(t, n, r) { !
                ...
                function(e) {
                    ...
                    function y(e) {
                        ...
                        }; Dn > un;) if (r = on.charCodeAt(un), ++un, s(r)) return pn = !0,
                        An.comments && (i = on.slice(t + e, un - 1), n.end = {
                            line: ln,
                            column: un - cn - 1
                        },
                        m("Line", i, t, un - 1, n)),
                        13 === r && 10 === on.charCodeAt(un) && ++un,
                        ++ln,
                        void(cn = un);
                    ...
                    function g() {
                        ...
                        }); Dn > un;) if (n = on.charCodeAt(un), s(n)) 13 === n && 10 === on.charCodeAt(un + 1) && ++un,
                        pn = !0,
                        ++ln,
                        ++un,
                        cn = un;
                        else if (42 === n) {
                            if (47 === on.charCodeAt(un + 1)) return++un,
                            ++un,
                            void(An.comments && (r = on.slice(e + 2, un - 2), t.end = {
                                line: ln,
                                column: un - cn
                            },
                            m("Block", r, e, un, t))); ++un
                    ...
                    function v() {
                        var e, t;
                        for (pn = !1, t = 0 === un; Dn > un;) if (e = on.charCodeAt(un), o(e))++un;
                        else if (s(e)) pn = !0,
                        ++un,
                        13 === e && 10 === on.charCodeAt(un) && ++un,
                        ++ln,
                        cn = un,
                        t = !0;
                        else if (47 === e) if (e = on.charCodeAt(un + 1), 47 === e)++un,
                        ++un,
                        y(2),
                        t = !0;
                        else {
                            ...
                            if (60 !== e) break;
                            if ("!--" !== on.slice(un + 1, un + 4)) break; ++un,
                            ++un,
                            ++un,
                            ++un,
                            y(4)
                    ...
                    function A() {
                        var e, t, n;
                        for (e = w(un), n = u(e), un += n.length, 92 === e && (117 !== on.charCodeAt(un) && te(), ++un, "{" === on[un] ? (++un, t = b()) : (t = D("u"), e = t.charCodeAt(0), t && "\\" !== t && l(e) || te()), n = t); Dn > un && (e = w(un), c(e));) t = u(e),
                        n += t,
                        un += t.length,
                        92 === e && (n = n.substr(0, n.length - 1), 117 !== on.charCodeAt(un) && te(), ++un, "{" === on[un] ? (++un, t = b()) : (t = D("u"), e = t.charCodeAt(0), t && "\\" !== t && c(e) || te()), n += t);
                        return n
                    }
                    function C() {
                        var e, t;
                        for (e = un++; Dn > un;) {
                            if (t = on.charCodeAt(un), 92 === t) return un = e,
                            A();
                            if (t >= 55296 && 57343 > t) return un = e,
                            A();
                            if (!c(t)) break; ++un
                        }
                    ...
                    function j() {
                        ...
                        if (a = on[un], t(n(a.charCodeAt(0)) || "." === a, "Numeric literal must start with a decimal digit or a decimal point"), r = un, e = "", "." !== a) {
                            if (e = on[un++], a = on[un], "0" === e) {
                                if ("x" === a || "X" === a) return++un,
                                F(r);
                                if ("b" === a || "B" === a) return++un,
                                S(r);
                        ...
                        if ("e" === a || "E" === a) if (e += on[un++], a = on[un], ("+" === a || "-" === a) && (e += on[un++]), n(on.charCodeAt(un))) for (; n(on.charCodeAt(un));) e += on[un++];
                        else te();
                    ...
                    function B() {
                        ...
                        for (e = on[un], t("'" === e || '"' === e, "String literal must starts with a quote"), n = un, ++un; Dn > un;) {
                            ...
                            if ("\\" === r) if (r = on[un++], r && s(r.charCodeAt(0)))++ln,
                            "\r" === r && "\n" === on[un] && ++un,
                            cn = un;
                            else switch (r) {
                            case "u":
                    ...
                    function I() {
                        ...
                        for (a = !1, u = !1, t = un, o = "`" === on[un], r = 2, ++un; Dn > un;) {
                            ...
                            if ("$" === e) {
                                ...
                                p += e
                            } else if ("\\" === e) if (e = on[un++], s(e.charCodeAt(0)))++ln,
                            "\r" === e && "\n" === on[un] && ++un,
                            cn = un;
                            else switch (e) {
                            case "n":
                    ...
                    function _(e, t) {
                        var n = "￿",
                        r = e;
                        t.indexOf("u") >= 0 && (r = r.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g,
                        function(e, t, r) {
                    ...
                    function T() {
                        var e, n, r, i, a;
                        for (e = on[un], t("/" === e, "Regular expression literal must start with a slash"), n = on[un++], r = !1, i = !1; Dn > un;) if (e = on[un++], n += e, "\\" === e) e = on[un++],
                    ...
                    function P() {
                        ...
                        for (t = "", n = ""; Dn > un && (e = on[un], c(e.charCodeAt(0)));) if (++un, "\\" === e && Dn > un) if (e = on[un], "u" === e) {
                            if (++un, r = un, e = D("u")) for (n += e, t += "\\u"; un > r; ++r) t += on[r];
                            else un = r,
                            n += "u",
                            t += "\\u";
                            ne()
                    ...
                    function re(e) {
                        var t = q(); (t.type !== Gt.Punctuator || t.value !== e) && te(t)
                    }
                    function ie() {
                        var e;
                    ...
                    function ae(e) {
                        var t = q(); (t.type !== Gt.Keyword || t.value !== e) && te(t)
                    }
                    function oe(e) {
                    ...
                    function de(e, t) {
                        ...
                        if (bn.type === Gt.Identifier) {
                            if (r = bn, n = Ze(), oe("=")) return e.push(r),
                            q(),
                            i = We(),
                            a.finishProperty("init", n, !1, new W(r).finishAssignmentPattern(n, i), !1, !1);
                            if (!oe(":")) return e.push(r),
                            a.finishProperty("init", n, !1, n, !1, !0)
                        } else n = we();
                        return re(":"),
                        i = ge(e, t),
                    ...
                    function Ce(e, t, n, r) {
                        ...
                        } else if (e.type === Gt.Punctuator && "*" === e.value && Ae()) return n = oe("["),
                        t = we(),
                        o = new J,
                        wn.allowYield = !0,
                        s = jt(),
                        ...
                        i = De(o, s, !0),
                        wn.allowYield = u,
                        r.finishProperty("init", t, n, i, !0, !1);
                    ...
                    function Oe() {
                        ...
                        if (re(")"), oe("=>")) {
                            ...
                            if (Cn || te(bn), e.type === tn.SequenceExpression) for (r = 0; r < e.expressions.length; r++) Fe(e.expressions[r]);
                            else Fe(e);
                            e = {
                                type: nn.ArrowParameterPlaceHolder,
                    ...
                    function je() {
                        ...
                        if (oe("[")) return he(ve);
                        if (oe("{")) return he(Ee);
                        if (e = bn.type, r = new J, e === Gt.Identifier)"module" === wn.sourceType && "await" === bn.value && ne(bn),
                        n = r.finishIdentifier(q().value);
                        else if (e === Gt.StringLiteral || e === Gt.NumericLiteral) xn = Cn = !1,
                        sn && bn.octal && ne(bn, rn.StrictOctalLiteral),
                        n = r.finishLiteral(q());
                    ...
                    function Pe() {
                        var e, t, n = new J;
                        if (ae("new"), oe(".")) {
                            if (q(), bn.type === Gt.Identifier && "target" === bn.value && wn.inFunctionBody) return q(),
                            n.finishMetaProperty("new", "target");
                            te(bn)
                        }
                        return e = pe(Re),
                        t = oe("(") ? Be() : [],
                    ...
                    function Le() {
                        ...
                        for (i = bn, wn.allowIn = !0, se("super") && wn.inFunctionBody ? (t = new J, q(), t = t.finishSuper(), oe("(") || oe(".") || oe("[") || te(bn)) : t = he(se("new") ? Pe: je);;) if (oe(".")) Cn = !1,
                        xn = !0,
                        r = _e(),
                    ...
                    function Re() {
                        var e, n, r, i;
                        for (t(wn.allowIn, "callee of new expression always allow in keyword."), i = bn, se("super") && wn.inFunctionBody ? (n = new J, q(), n = n.finishSuper(), oe("[") || oe(".") || te(bn)) : n = he(se("new") ? Pe: je);;) if (oe("[")) Cn = !1,
                        xn = !0,
                        r = Te(),
                    ...
                    function Ne() {
                        ...
                        for (xn = Cn = !1, r.prec = i, q(), t = [e, bn], o = pe(Ue), a = [u, r, o]; (i = Me(bn, wn.allowIn)) > 0;) {
                            ...
                            u = a.pop(),
                            t.pop(),
                            n = new W(t[t.length - 1]).finishBinaryExpression(s, u, o),
                            a.push(n);
                            r = q(),
                            r.prec = i,
                            a.push(r),
                        ...
                        for (l = a.length - 1, n = a[l], t.pop(); l > 1;) n = new W(t.pop()).finishBinaryExpression(a[l - 1].value, a[l - 2], n),
                        l -= 2;
                        return n
                    }
                    function qe() {
                    ...
                    function ze(e) {
                        ...
                        if (sn || !wn.allowYield) for (t = 0, n = i.length; n > t; t += 1) r = i[t],
                        r.type === tn.YieldExpression && te(bn);
                    ...
                    function mt(e) {
                        ...
                        wn.allowIn = f,
                        1 === c.length && se("in") ? (t = t.finishVariableDeclaration(c), q(), s = t, u = Ke(), t = null) : 1 === c.length && null === c[0].init && ue("of") ? (t = t.finishVariableDeclaration(c), q(), s = t, u = We(), t = null, n = !1) : (t = t.finishVariableDeclaration(c), re(";"));
                        else if (se("const") || se("let")) t = new J,
                        l = q().value,
                        sn || "in" !== bn.value ? (wn.allowIn = !1, c = it(l, {
                            inFor: !0
                        ...
                        else if (i = bn, wn.allowIn = !1, t = he(We), wn.allowIn = f, se("in")) xn || Z(rn.InvalidLHSInForIn),
                        q(),
                        Fe(t),
                        s = t,
                        u = Ke(),
                        t = null;
                        else if (ue("of")) xn || Z(rn.InvalidLHSInForLoop),
                        q(),
                        Fe(t),
                        s = t,
                        u = We(),
                    ...
                    function bt() {
                        var e, t, n = [],
                        r = new J;
                        for (se("default") ? (q(), e = null) : (ae("case"), e = Ke()), re(":"); Dn > mn && !(oe("}") || se("default") || se("case"));) t = Qe(),
                        n.push(t);
                        return r.finishSwitchCase(e, n)
                    }
                    function wt(e) {
                        var t, n, r, i, a;
                        if (ae("switch"), re("("), t = Ke(), re(")"), re("{"), n = [], oe("}")) return q(),
                        e.finishSwitchStatement(t, n);
                        for (i = wn.inSwitch, wn.inSwitch = !0, a = !1; Dn > mn && !oe("}");) r = bt(),
                        null === r.test && (a && G(rn.MultipleDefaultsInSwitch), a = !0),
                        n.push(r);
                    ...
                    function Ct() {
                        ...
                        a = {},
                        o = new J;
                        for (ae("catch"), re("("), oe(")") && te(bn), e = ye(i), n = 0; n < i.length; n++) t = "$" + i[n].value,
                        Object.prototype.hasOwnProperty.call(a, t) && Z(rn.DuplicateBinding, i[n].value),
                        a[t] = !0;
                    ...
                    function St() {
                        var e, t, n, r, i, a, o, s, u, l = [],
                        c = new J;
                        for (re("{"); Dn > mn && bn.type === Gt.StringLiteral && (t = bn, e = Qe(), l.push(e), e.expression.type === tn.Literal);) n = on.slice(t.start + 1, t.end - 1),
                        "use strict" === n ? (sn = !0, r && ne(r, rn.StrictOctalLiteral)) : !r && t.octal && (r = t);
                        for (i = wn.labelSet, a = wn.inIteration, o = wn.inSwitch, s = wn.inFunctionBody, u = wn.parenthesizedCount, wn.labelSet = {},
                        wn.inIteration = !1, wn.inSwitch = !1, wn.inFunctionBody = !0, wn.parenthesizedCount = 0; Dn > mn && !oe("}");) l.push(Qe());
                        return re("}"),
                        wn.labelSet = i,
                        wn.inIteration = a,
                        wn.inSwitch = o,
                    ...
                    function Ot(e) {
                        var t, n, r, i, a = [];
                        if (t = bn, "..." === t.value) return n = lt(a),
                        kt(e, n.argument, n.argument.name),
                        e.params.push(n),
                    ...
                    function Jt() {
                        for (var e, t, n, r, i = []; Dn > mn && (t = bn, t.type === Gt.StringLiteral) && (e = Qe(), i.push(e), e.expression.type === tn.Literal);) n = on.slice(t.start + 1, t.end - 1),
                        "use strict" === n ? (sn = !0, r && ne(r, rn.StrictOctalLiteral)) : !r && t.octal && (r = t);
                    ...
                    function Kt() {
                        var e, t, n, r = [];
                        for (e = 0; e < An.tokens.length; ++e) t = An.tokens[e],
                        n = {
                            type: t.type,
                            value: t.value
                        },
                        ...
                        processComment: function() {
                            ...
                            if (! (this.type === tn.Program && this.body.length > 0)) {
                                if (this.type === tn.BlockStatement && 0 === this.body.length) {
                                    for (t = [], i = An.leadingComments.length - 1; i >= 0; --i) a = An.leadingComments[i],
                                    this.range[1] >= a.range[1] && (t.unshift(a), An.leadingComments.splice(i, 1), An.trailingComments.splice(i, 1));
                                    if (t.length) return void(this.innerComments = t)
                                }
                                if (An.trailingComments.length > 0) {
                                    for (r = [], i = An.trailingComments.length - 1; i >= 0; --i) a = An.trailingComments[i],
                                    a.range[0] >= this.range[1] && (r.unshift(a), An.trailingComments.splice(i, 1));
                                    An.trailingComments = []
                                } else s && s.trailingComments && s.trailingComments[0].range[0] >= this.range[1] && (r = s.trailingComments, delete s.trailingComments);
                                for (; s && s.range[0] >= this.range[0];) e = o.pop(),
                                s = o[o.length - 1];
                                if (e) {
                                    if (e.leadingComments) {
                                        for (n = [], i = e.leadingComments.length - 1; i >= 0; --i) a = e.leadingComments[i],
                                        a.range[1] <= this.range[0] && (n.unshift(a), e.leadingComments.splice(i, 1));
                                        e.leadingComments.length || (e.leadingComments = void 0)
                                    }
                                } else if (An.leadingComments.length > 0) for (n = [], i = An.leadingComments.length - 1; i >= 0; --i) a = An.leadingComments[i],
                                a.range[1] <= this.range[0] && (n.unshift(a), An.leadingComments.splice(i, 1));
            ...
            52 : [function(t, n, r) { !
                function(t) {
                    ...
                    function s() {
                        ...
                        i = e[n ? 1 : 0] || {},
                        s = e[n ? 2 : 1],
                        u = i.__constructor || n && r.prototype.__constructor ?
                        function() {
                    ...
                    "object" == typeof modules && (modules.define("inherit",
                    function(e) {
                        e(s)
                    }), A = !1),
            ...
            96 : [function(e, t, n) {
                function r(e, t, n) {
                    ...
                    if ("number" == typeof t && t === t && s >= o) {
                        for (; o > r;) {
                            var u = r + o >>> 1,
                            l = e[u]; (n ? t >= l: t > l) && null !== l ? r = u + 1 : o = u
                        }
                        return o
                    }
                    return i(e, t, a, n)
            ...
            97 : [function(e, t, n) {
                function r(e, t, n, r) {
                    t = n(t);
                    for (var o = 0,
                    u = e ? e.length: 0, l = t !== t, c = null === t, p = void 0 === t; u > o;) {
                        var h = i((o + u) / 2),
                        f = n(e[h]),
                        d = void 0 !== f,
                        m = f === f;
            ...
            100 : [function(e, t, n) {
                function r(e, t, n) {
                    for (var r = n.length,
                    a = -1,
                    o = i(e.length - r, 0), s = -1, u = t.length, l = Array(u + o); ++s < u;) l[s] = t[s];
                    for (; ++a < r;) l[n[a]] = e[a];
                    for (; o--;) l[s++] = e[a++];
                    return l
                }
            ...
            101 : [function(e, t, n) {
                function r(e, t, n) {
                    ...
                    a = n.length,
                    o = -1,
                    s = i(e.length - a, 0), u = -1, l = t.length, c = Array(s + l); ++o < s;) c[o] = e[o];
            ...
            108 : [function(e, t, n) { (function(n) {
                    function r(e, t, w, A, C, x, E, F, S, k) {
                        function O() {
                            for (var d = arguments.length,
                            m = d,
                            y = Array(d); m--;) y[m] = arguments[m];
            ...
            138 : [function(e, t, n) {
                function r(e) {
                    for (var t = l(e), n = t.length, r = n && e.length, c = !!r && s(r) && (a(e) || i(e) || u(e)), h = -1, f = []; ++h < n;) {
                        var d = t[h]; (c && o(d, r) || p.call(e, d)) && f.push(d)
                    }
                    return f
                }
            ...
            154 : [function(e, t, n) {
                function r(e) {
                    ...
                    r = -1,
                    i = s(n) && n.prototype || x, f = i === e, d = Array(t), m = t > 0, g = h.enumErrorProps && (e === C || e instanceof Error), v = h.enumPrototypes && s(e); ++r < t;) d[r] = r + "";
                    ...
                    function(t) {
                        ...
                        function d(e) {
                            return f(function(t, n) {
                                for (var r = 0,
                                i = e.length; i > r; r++) p(e[r]).then(t, n)
                            })
                        }
                        function m(e, t, n) {
                        ...
                        function x(e, n) {
                            ue && ("object" == typeof t && "function" == typeof t.emit && p.nextTick.runAfter(function() { - 1 !== G(oe, e) && (t.emit("unhandledRejection", n, e), se.push(e))
                        ...
                        function L(e) {
                            ...
                            function(e) {
                                ...
                                function(r, i, a) {
                                    var o;
                                    v(i) && "fulfilled" === (o = i.inspect()).state ? e[a] = o.value: (++t, y(i,
                                    function(r) {
                                        e[a] = r,
                                        0 === --t && n.resolve(e)
                                    },
                        ...
                        W = function() {
                            ...
                            "object" == typeof t && "[object process]" === t.toString() && t.nextTick) s = !0,
                            o = function() {
                                t.nextTick(e)
                            };
                        ...
                        G = e(Array.prototype.indexOf ||
                        function(e) {
                            for (var t = 0; t < this.length; t++) if (this[t] === e) return t;
                            return - 1
                        }),
                        Z = e(Array.prototype.map ||
                        function(e, t) {
                            var n = this,
                            r = [];
                            return X(n,
    ...
    SwaggerUi.Views.OperationView = Backbone.View.extend({
        ...
        render: function() {
            ...
            } else for (o in m) if (L = m[o], "oauth2" === o) for (null === this.model.oauth && (this.model.oauth = {}), void 0 === this.model.oauth.scopes && (this.model.oauth.scopes = []), d = 0, c = L.length; c > d; d++) g = L[d],
            this.model.oauth.scopes.push(g);
            if ("undefined" != typeof this.model.responses) {
                ...
                for (r in C) R = C[r],
                O = null,
                j = this.model.responses[r].schema,
                j && j.$ref && (O = j.$ref, -1 !== O.indexOf("#/definitions/") && (O = O.replace(/^.*#\/definitions\//, ""))),
            ...
            if ("undefined" == typeof this.model.responseMessages && (this.model.responseMessages = []), I = null, this.model.successResponse) {
                ...
                "object" == typeof R && "function" == typeof R.createJSONSample && (this.model.successDescription = R.description, this.model.headers = this.parseResponseHeaders(R.headers), I = {
            ...
            i.consumes = this.model.consumes, i.produces = this.model.produces, x = this.model.parameters, y = 0, p = x.length; p > y; y++) D = x[y],
            P = D.type || D.dataType || "",
            "undefined" == typeof P && (O = D.schema, O && O.$ref && (w = O.$ref, P = 0 === w.indexOf("#/definitions/") ? w.substring("#/definitions/".length) : w)),
            P && "file" === P.toLowerCase() && (i.consumes || (i.consumes = "multipart/form-data")),
            D.type = P;
            for (S = new SwaggerUi.Views.ResponseContentTypeView({
                model: i,
                router: this.router
            }), $(".response-content-type", $(this.el)).append(S.render().el), E = this.model.parameters, v = 0, h = E.length; h > v; v++) D = E[v],
            this.addParameter(D, i.consumes);
            for (F = this.model.responseMessages, b = 0, f = F.length; f > b; b++) _ = F[b],
            this.addStatusCode(_);
            return this
        },
        ...
        getInputMap: function(e) {
            ...
            for (o = e.find("textarea"), s = 0, u = o.length; u > s; s++) a = o[s],
            l = this.getTextAreaValue(a),
            null !== l && jQuery.trim(l).length > 0 && (t[a.name] = l);
            for (c = e.find("select"), p = 0, h = c.length; h > p; p++) a = c[p],
            l = this.getSelectedValue(a),
            null !== l && jQuery.trim(l).length > 0 && (t[a.name] = l);
            return t
        },
    ...
    SwaggerUi.Views.SignatureView = Backbone.View.extend({
        ...
        snippetToTextArea: function(e) {
            if (this.isParam) {
                e && e.preventDefault();
                var t = $("textarea", $(this.el.parentNode.parentNode.parentNode)); ("" === $.trim(t.val()) || t.prop("placeholder") === t.val()) && (t.val(this.model.sampleJSON), this.model.jsonEditor && this.model.jsonEditor.isEnabled() && this.model.jsonEditor.setValue(JSON.parse(this.model.sampleJSON)))
            }
        }
    }),
