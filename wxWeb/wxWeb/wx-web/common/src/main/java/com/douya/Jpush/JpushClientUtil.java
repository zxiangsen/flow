...
public class JpushClientUtil {
    ...
    //private final static String appKey = "a6dd0018e291618999fe6e1f";
    private final static String appKey = "b65efe003269c0d4732b1269";

    //private final static String masterSecret = "f1c62c837a3897ef3fda0baf";
    private final static String masterSecret = "318de2ab9e19b1a2c6c1e63a";
    ...
    public static void main(String[] args){
	    // 所有用户
    /*    if(JpushClientUtil.sendToAll("L45029201710091758011011!","testIos","this is a ios Dev test","")==1){
                System.out.println("success");
	    	  }*/
      // 所有 ios用户
     /*   if(JpushClientUtil.sendToAllIos("L45029201710091758011011!","testIos","this is a ios Dev test","")==1){
            System.out.println("success");
        }*/

        //发送给所有安卓用户
       /* if(JpushClientUtil.sendToAllAndroid("45029201710091758011011!","testIos","this is a ios Dev test","")==1){
            System.out.println("success");
        }*/

        //
        // 指定用户
        if(JpushClientUtil.sendToRegistrationId("100d85590914f0dd056","guolaoshi","testIos","this is a ios Dev test","")==1){
            System.out.println("success");
        }
